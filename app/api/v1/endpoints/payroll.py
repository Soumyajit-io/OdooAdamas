...
async def get_own_payroll(current_user: UserResponse = Depends(get_current_user)):
    """
...
async def get_all_payrolls(admin_user: UserResponse = Depends(get_current_admin)):
    """
